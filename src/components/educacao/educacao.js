  ...
  return (
    <main>
      <div className="main__container">
        ...
        <div className="card2" id="refeicao4">
        ...
        <div className="cards_transf">
          <button className="card" id="mobilidade4" class="glow-on-hover" onClick={() => putSaldosInfo("refeicao", commentary, pessoas[0]?.refeicao)}>
            <div className="target__ben" >
              <p>REFEIÇAO</p>
            </div>
          </button>
          
          <button className="card" id="cultura4" class="glow-on-hover" onClick={() => putSaldosInfo("cultura", commentary, pessoas[0]?.cultura)}>
          ...
          <button className="card" id="saude4" class="glow-on-hover" onClick={() => putSaldosInfo("saude", commentary, pessoas[0]?.saude)}>
            <div className="target__ben">
              <p >SAUDE</p>
            </div>
          </button>

          <button className="card" id="educacao4" class="glow-on-hover" onClick={() => putSaldosInfo("mobilidade", commentary, pessoas[0]?.mobilidade)}>
            <div className="target__ben">
              <p >MOBILIDADE</p>
            </div>
          </button>
