...
const Saude = () => {
  ...
  async function putSaldosInfo(destino, valor, valorAnterior) {
    ...
    const response = await api.put('/pessoas/1', {
      origem: "saude",
      saldoOrigem: Number(pessoas[0]?.saude) - Number(valor),
      destino: destino,
  ...
  return (
    <main>
      <div className="main__container">
        ...
        <div className="card2" id="refeicao2">
          <div className="target_transf2">
        ...
        <div className="cards_transf">
          <button className="card" id="mobilidade2" class="glow-on-hover" onClick={() => putSaldosInfo("refeicao", commentary, pessoas[0]?.refeicao)}>
            <div className="target__ben" >
              <p>REFEIÇAO</p>
            </div>
          </button>
          
          <button className="card" id="cultura2" class="glow-on-hover" onClick={() => putSaldosInfo("cultura", commentary, pessoas[0]?.cultura)}>
          ...
          <button className="card" id="saude2" class="glow-on-hover" onClick={() => putSaldosInfo("mobilidade", commentary, pessoas[0]?.mobilidade)}>
            <div className="target__ben">
              <p >MOBILIDADE</p>
            </div>
          </button>

          <button className="card" id="educacao2" class="glow-on-hover" onClick={() => putSaldosInfo("educacao", commentary, pessoas[0]?.educacao)}>
            <div className="target__ben">
              <p >EDUCAÇAO</p>
            </div>
          </button>
